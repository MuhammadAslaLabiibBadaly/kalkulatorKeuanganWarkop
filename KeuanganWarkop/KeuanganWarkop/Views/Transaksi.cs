...
namespace KeuanganWarkop
{
    public partial class Transaksi : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Kategori dan nominal tidak boleh kosong.", "Validasi", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            try
            {
                ...
                controller.SimpanTransaksi(tanggal, kategori, Convert.ToDecimal(nominal), deskripsi);
